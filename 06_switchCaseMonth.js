function monthOfYear(month) {
  switch (month) {
    ...
    default:
        ...
        console.log(`${month}  Enter the valid input`);
      break;
  }
}
monthOfYear(0),monthOfYear(2),monthOfYear(5),monthOfYear(12),monthOfYear(15),monthOfYear(100),monthOfYear(null),monthOfYear(undefined);
